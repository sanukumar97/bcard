...
class _LoginPageState extends State<LoginPage>
  ...
  final FocusNode myFocusNodeDesignation = FocusNode();
  ...
  TextEditingController signupDesignationController =
                  ...
                  child: RaisedButton(
                    ...
                    onPressed: () async {
                      ...
                      CreateUserModel createUserModel = CreateUserModel(
                          ...
                          "");
                      dynamic errmsg =
                          await loginUser(context, createUserModel);
                        ...
                        children: <Widget>[
                          ...
                          Padding(
                            ...
                            child: TextFormField(
                              ...
                              focusNode: myFocusNodeDesignation,
                              controller: signupDesignationController,
                              keyboardType: TextInputType.text,
                              textCapitalization: TextCapitalization.words,
                              style: TextStyle(
                                  fontFamily: "WorkSansSemiBold",
                          ...
                          Padding(
                            ...
                            child: TextFormField(
                              validator: (value) {
                                if (value.length < 8) {
                                  return "Password must contains 8 chars";
                                }
                                return null;
                              },
                  ...
                  child: RaisedButton(
                    ...
                    onPressed: () async {
                      if (_signUpKey.currentState.validate()) {
                        ...
                        final errmsg =
                            await createUser(context, createUserModel);
                        if (errmsg != null) {
                          showInSnackBar(_scaffoldKey, errmsg);
                        } else {
                          Navigator.pushAndRemoveUntil(
